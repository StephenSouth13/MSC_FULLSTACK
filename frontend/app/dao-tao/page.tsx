...
export default function TrainingPage() {
    ...
    const coreValues = [
      { title: "Mentoring & Coaching kỹ năng Marketing và Sales", description: "Định hình tư duy thị trường, nâng cao kỹ năng truyền thông – bán hàng thông qua các chương trình mentoring & coaching thực chiến.", color: "text-[#0077B6]", darkColor: "dark:text-[#48cae4]"},
      { title: "Đào tạo kỹ năng Nghiên cứu, Thẩm định & Đánh giá dự án", description: "Trang bị phương pháp tiếp cận và phân tích dự án theo mô hình Holding: Sản phẩm – Con người – Tài chính, giúp học viên tư duy hệ thống và ra quyết định chiến lược.", color: "text-[#2A9D8F]", darkColor: "dark:text-[#80ed99]"},
      { title: "Đào tạo Quản lý dự án (Trước-Trong-Sau)", description: "Phát triển năng lực lãnh đạo dự án qua toàn bộ vòng đời: từ hoạch định – triển khai – tổng kết, kết hợp thực hành và công cụ quản trị hiện đại.", color: "text-[#F4A261]", darkColor: "dark:text-[#ffb703]"},
    ];
    ...
    return (
      <div className="bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-50">
        ...
        <section ref={mscSectionRef} className="py-24 bg-gray-50 dark:bg-gray-950 overflow-hidden">
          <div className="container text-center max-w-5xl mx-auto">
            <div className="flex flex-col items-center justify-center space-y-4">
              <h2 className="text-4xl md:text-6xl font-extrabold tracking-tight text-gray-900 dark:text-gray-50">
                <motion.span
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 text-left">
              {coreValues.map((value, index) => (
                <motion.div 
                  key={index}
                  className="p-8 bg-white dark:bg-gray-900 rounded-2xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300"
                  custom={index}
                  variants={cardVariant}
                  initial="hidden"
                  animate={isMscInView ? "visible" : "hidden"}
                >
                  <h4 className={`text-xl font-bold ${value.color} ${value.darkColor} mb-3 font-serif`}>{value.title}</h4>
        ...
        <section className="py-20 bg-white dark:bg-gray-900">
          <div className="container">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900 dark:text-gray-50 font-serif">Tại sao chọn MSC Center?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {benefits.map((benefit, index) => (
                <div key={index} className="text-center p-6 bg-white dark:bg-gray-900 hover:shadow-lg transition-all duration-300 rounded-xl">
                  ...
                  <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-gray-50">{benefit.title}</h3>
        ...
        <section className="py-20 bg-gray-50 dark:bg-gray-950">
          <div className="container">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900 dark:text-gray-50 font-serif">Chương trình đào tạo</h2>
              <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {programs.map((program) => (
                <Card key={program.id} className="overflow-hidden hover:shadow-xl transition-all duration-300 dark:bg-gray-900 dark:border-gray-800">
                  ...
                  <CardHeader>
                    <CardTitle className="text-xl font-bold text-gray-900 dark:text-gray-50">{program.title}</CardTitle>
                  ...
                  <CardContent>
                    ...
                    <div className="mb-6">
                      <h4 className="font-semibold text-gray-900 dark:text-gray-50 mb-3">Nội dung chính:</h4>
                      <ul className="space-y-2">
                        {program.highlights.slice(0, 3).map((highlight, index) => (
                          <li key={index} className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400"><CheckCircle className="h-4 w-4 text-green-500 flex-shrink-0" /><span>{highlight}</span></li>
                        ))}
                      </ul>
                    </div>
        ...
        <section className="py-20 bg-white dark:bg-gray-900">
          <div className="container">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900 dark:text-gray-50 font-serif">THƯ VIỆN ẢNH</h2>
              <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">Hình ảnh đào tạo tại các dự án !</p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-teal-600 text-white">
          <div className="container text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/lien-he"><Button size="lg" className="bg-white text-blue-600 hover:bg-gray-100 dark:bg-gray-50 dark:text-blue-600 dark:hover:bg-gray-200 px-8 py-4">Đăng ký tư vấn miễn phí</Button></Link>
              <Link href="/chia-se"><Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 dark:border-gray-50 dark:text-gray-50 dark:hover:bg-gray-50/10 px-8 py-4 bg-transparent">Tải brochure</Button></Link>
            </div>
          </div>
        </section>
