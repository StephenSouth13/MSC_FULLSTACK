//frontend/app/mentors/[id]/MentorClient.tsx
"use client";
...
          <button className="px-4 py-2 bg-gradient-to-r from-blue-400 to-blue-600 text-white rounded-full text-sm">Về Trang Mentors</button>
...
          {mentor.title && (
            <p className="text-lg opacity-80">{mentor.title}</p>
          )}
          {mentor.role && (
            <p className="text-sm opacity-60">{mentor.role}</p>
          )}
        </div>
      </div>
    
