...
export default function MentorsPage() {
  ...
  const teachingMethods = {
    ...
    description:
      "Chúng tôi áp dụng mô hình đào tạo 70-20-10, kết hợp lý thuyết, thực hành và học hỏi qua trải nghiệm thực tế để đảm bảo hiệu quả cao nhất.",
    points: [
      {
        icon: GraduationCap,
      ...
      },
      {
        ...
        text: "Tương tác, thảo luận và học hỏi từ các cố vấn và các học viên khác trong cộng đồng MSCer ưu tú.",
      },
      {
        icon: Briefcase,
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* CONTENT */}
      <main className="py-24 bg-gray-50 dark:bg-gray-900">
        <div className="container">
          <AnimatePresence mode="wait">
            ...
            {activeTab === 'faculty' && (
              ...
              >
                {/* Khung bo tròn tổng thể */}
                <div className="rounded-3xl bg-white/70 dark:bg-gray-900/60 backdrop-blur-md border border-gray-200 dark:border-gray-700 shadow-xl p-8">
                  <motion.div
                  ...
                  >
                    {faculty.map((mentor) => (
                      <motion.div key={mentor.id} variants={itemVariants}>
                        <Card
                          className="h-full flex flex-col group overflow-hidden bg-white hover:shadow-2xl 
                                     transition-all duration-300 rounded-2xl text-center border 
                        ...
                        >
                          <CardContent className="p-8 flex flex-col flex-grow items-center">
                            <Image
                              ...
                              width={160}
                              height={160}
                              className="rounded-full w-40 h-40 object-cover border-4 border-white shadow-lg mb-6 dark:border-gray-700"
                            />
                            ...
                            <Badge
                              variant="secondary"
                              className="my-3 text-sm bg-blue-100 text-blue-800 dark:bg-blue-950 dark:text-blue-200"
                            >
                              {mentor.title}
                            </Badge>
                            <p className="text-gray-600 mb-6 flex-grow dark:text-gray-300">
                              {mentor.description}
                            </p>
                              ...
                              <Link href={`/mentors/${mentor.id}`}>
                                <Button
                                  ...
                                  className="w-full group-hover:bg-blue-500 group-hover:text-white 
                                             dark:text-white dark:border-gray-600 dark:hover:bg-blue-700"
                                >
            ...
            {activeTab === 'methods' && (
              ...
              >
                ...
                <motion.div
                  ...
                  animate="visible"
                >
                  {teachingMethods.points.map((point, idx) => (
                    <motion.div key={idx} variants={itemVariants}>
                      <Card className="p-8 flex items-start space-x-6 bg-white shadow-lg rounded-2xl dark:bg-gray-800 dark:border-gray-700">
            ...
            {activeTab === 'successors' && (
              ...
              >
                <Sparkles className="mx-auto h-16 w-16 text-yellow-500 mb-6 dark:text-yellow-400" />
                <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900 dark:text-white font-serif">
                  Nhân sự Kế thừa
                </h2>
                <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                  Nội dung về chương trình "Nhân sự Kế thừa" đang được chúng tôi xây dựng và sẽ sớm ra mắt.
                  Đây là chương trình chiến lược nhằm phát hiện, đào tạo và phát triển những tài năng trẻ để
                  trở thành thế hệ lãnh đạo tiếp theo cho MSC và các doanh nghiệp đối tác.
                </p>
        ...
        <div className="container text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto dark:text-gray-300">
              Hãy để đội ngũ chuyên gia của MSC Center đồng hành cùng bạn. Khám phá các khóa học phù hợp
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/lien-he">
                <Button
                  size="lg"
                  variant="outline"
                  className="text-lg px-10 py-6 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700"
                >
                  Liên hệ tư vấn
                </Button>
              </Link>
